...
func (m *MetricsViewSpec) validate(all bool) error {
	...
	for idx, item := range m.GetTableOptions() {
		_, _ = idx, item
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, MetricsViewSpecValidationError{
						field:  fmt.Sprintf("TableOptions[%v]", idx),
						reason: "embedded message failed validation",
						cause:  err,
					})
				}
...
// Validate checks the field values on MetricsViewSpec_TableOption with the
// rules defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *MetricsViewSpec_TableOption) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on MetricsViewSpec_TableOption with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// MetricsViewSpec_TableOptionMultiError, or nil if none found.
func (m *MetricsViewSpec_TableOption) ValidateAll() error {
	return m.validate(true)
}

func (m *MetricsViewSpec_TableOption) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return MetricsViewSpec_TableOptionMultiError(errors)
	}

	return nil
}

// MetricsViewSpec_TableOptionMultiError is an error wrapping multiple
// validation errors returned by MetricsViewSpec_TableOption.ValidateAll() if
// the designated constraints aren't met.
type MetricsViewSpec_TableOptionMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m MetricsViewSpec_TableOptionMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m MetricsViewSpec_TableOptionMultiError) AllErrors() []error { return m }

// MetricsViewSpec_TableOptionValidationError is the validation error returned
// by MetricsViewSpec_TableOption.Validate if the designated constraints
// aren't met.
type MetricsViewSpec_TableOptionValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e MetricsViewSpec_TableOptionValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e MetricsViewSpec_TableOptionValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e MetricsViewSpec_TableOptionValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e MetricsViewSpec_TableOptionValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e MetricsViewSpec_TableOptionValidationError) ErrorName() string {
	return "MetricsViewSpec_TableOptionValidationError"
}

// Error satisfies the builtin error interface
func (e MetricsViewSpec_TableOptionValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sMetricsViewSpec_TableOption.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = MetricsViewSpec_TableOptionValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = MetricsViewSpec_TableOptionValidationError{}
...
// Validate checks the field values on MetricsViewSpec_Dimension_ValueLink with
// the rules defined in the proto definition for this message. If any rules
// are violated, the first error encountered is returned, or nil if there are
// no violations.
func (m *MetricsViewSpec_Dimension_ValueLink) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on MetricsViewSpec_Dimension_ValueLink
// with the rules defined in the proto definition for this message. If any
// rules are violated, the result is a list of violation errors wrapped in
// MetricsViewSpec_Dimension_ValueLinkMultiError, or nil if none found.
func (m *MetricsViewSpec_Dimension_ValueLink) ValidateAll() error {
	return m.validate(true)
}

func (m *MetricsViewSpec_Dimension_ValueLink) validate(all bool) error {
	if m == nil {
		return nil
	}
...
// MetricsViewSpec_Dimension_ValueLinkMultiError is an error wrapping multiple
// validation errors returned by
// MetricsViewSpec_Dimension_ValueLink.ValidateAll() if the designated
// constraints aren't met.
type MetricsViewSpec_Dimension_ValueLinkMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m MetricsViewSpec_Dimension_ValueLinkMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m MetricsViewSpec_Dimension_ValueLinkMultiError) AllErrors() []error { return m }

// MetricsViewSpec_Dimension_ValueLinkValidationError is the validation error
// returned by MetricsViewSpec_Dimension_ValueLink.Validate if the designated
// constraints aren't met.
type MetricsViewSpec_Dimension_ValueLinkValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e MetricsViewSpec_Dimension_ValueLinkValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e MetricsViewSpec_Dimension_ValueLinkValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e MetricsViewSpec_Dimension_ValueLinkValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e MetricsViewSpec_Dimension_ValueLinkValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e MetricsViewSpec_Dimension_ValueLinkValidationError) ErrorName() string {
	return "MetricsViewSpec_Dimension_ValueLinkValidationError"
}

// Error satisfies the builtin error interface
func (e MetricsViewSpec_Dimension_ValueLinkValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sMetricsViewSpec_Dimension_ValueLink.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = MetricsViewSpec_Dimension_ValueLinkValidationError{}
